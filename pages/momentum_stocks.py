...
def run_simulation(df):
    ...
    f_date = entry_date.strftime('%d/%m %H:%M')
...
with st.sidebar:
    ...
    if c1.button("🚀 ESCANEAR", type="primary"):
        ...
        # Nota: targets tiene formato raw "BTC/USDT:USDT", existing tiene "BTC"
        # Ajustamos lógica de filtrado
...
if st.session_state['crypto_master_results']:
    ...
    st.dataframe(
        ...
        column_config={
            ...
            "S_Info": st.column_config.TextColumn("Detalle Semanal", width="large"),
            
            "D_Signal": st.column_config.TextColumn("Diario"),
            "D_Info": st.column_config.TextColumn("Detalle Diario", width="large"),
            
            "4H_Signal": st.column_config.TextColumn("4 Horas"),
            "4H_Info": st.column_config.TextColumn("Detalle 4H", width="large"),
        },
