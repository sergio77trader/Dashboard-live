...
# ─────────────────────────────────────────────
st.set_page_config(layout="wide", page_title="SLY | CRIPTO SIGNAL MONITOR")
...
CRYPTO_SECTOR_MAP = {
    ...
    "TOP ALTS": ["SOL/USDT", "BNB/USDT", "XRP/USDT", "ADA/USDT", "DOGE/USDT", "DOT/USDT", "AVAX/USDT", "MATIC/USDT", "LTC/USDT", "BCH/USDT"],
    "AI & DATA": ["RNDR/USDT", "FET/USDT", "NEAR/USDT", "GRT/USDT", "OCEAN/USDT"],
    "DEFI & L2": ["ARB/USDT", "OP/USDT", "UNI/USDT", "LINK/USDT", "AAVE/USDT", "LDO/USDT", "MKR/USDT"],
...
# ─────────────────────────────────────────────
# MOTOR TÉCNICO SLY (DEMA ZERO-LAG)
# ─────────────────────────────────────────────
def get_sly_indicators(df):
    try:
        # Normalizar nombres de columnas de CCXT
...
# ─────────────────────────────────────────────
# MÁQUINA DE ESTADOS (Búsqueda de Señal)
# ─────────────────────────────────────────────
...
with st.sidebar:
    ...
    if st.session_state["all_symbols"]:
        ...
        bear_longs = st.checkbox("Bear-Longs (1D)", value=True)
        ...
        if st.button("🚀 2. ACTUALIZAR Y ACUMULAR"):
            ...
            for i, sym in enumerate(subset):
                try:
                    ...
                    ohlcv = ex.fetch_ohlcv(sym, timeframe="1d", limit=500)
...
if st.session_state["master_results_crypto"]:
    ...
    else: st.warning("Sin posiciones abiertas.")
    ...
    st.info("Sincronice el mercado y actualice lotes para ver resultados.")
