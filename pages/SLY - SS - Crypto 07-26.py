...
# Inicialización CRÍTICA de Session State (Evita KeyError)
...
CRYPTO_SECTOR_MAP = {
    ...
    "TOP ALTS": ["SOL/USDT", "BNB/USDT", "XRP/USDT", "ADA/USDT", "DOGE/USDT", "DOT/USDT", "AVAX/USDT", "MATIC/USDT", "LTC/USDT", "LINK/USDT"],
...
# INTERFAZ Y CONTROL
# ─────────────────────────────────────────────
st.title("🛡️ SLY | CRIPTO MONITOR 4H")
...
if st.session_state["master_results_crypto"]:
    ...
    st.subheader("📊 RESUMEN DE EXPOSICIÓN (VIGENTES 4H)")
